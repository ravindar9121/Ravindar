...
const Hero = () => {
  ...
  const linkedInLink = () => {
    window.location.href = "https://www.linkedin.com/in/kakunuri-ravi";
  };
  ...
  return (
    <div id="home" className="hero">
      ...
      <h1>I'm Ravindar Reddy Kakunuri</h1>
      ...
      <p>
        Experienced in building scalable applications with 6+ years of hands-on
